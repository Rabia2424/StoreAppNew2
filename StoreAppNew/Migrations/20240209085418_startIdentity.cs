    ...
    public partial class startIdentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "/images/1.jpg", 10000m, "Computer", true, "" },
                    { 2, 2, "/images/2.jpg", 1000m, "Keyboard", false, "" },
                    { 3, 2, "/images/8.jpg", 500m, "Mouse", false, "" },
                    { 4, 2, "/images/4.jpg", 8000m, "Monitor", false, "" },
                    { 5, 2, "/images/5.jpg", 2000m, "Deck", false, "" },
                    { 6, 1, "/images/6.jpg", 50m, "History", false, "" },
                    { 7, 1, "/images/7.jpg", 80m, "Hamlet", false, "" },
                    { 8, 2, "/images/8.jpg", 80m, "Hp Mouse", true, "" }
                });
